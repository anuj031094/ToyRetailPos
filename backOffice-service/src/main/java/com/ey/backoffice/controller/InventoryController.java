...
//    public ResponseEntity<String> rollbackInventory(@RequestBody InventoryRequest request) {
//        try {
//            String response = inventoryService.rollbackInventory(request.getItemName(),request.getQuantity());
//            return ResponseEntity.ok(response);
//        } catch (Exception e) {
//            return ResponseEntity.status(500).body("Error: " + e.getMessage());
//        }
